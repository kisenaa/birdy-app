...
import { DashboardTabParamList, DashboardTabScreenProps } from "../../navigators/DashboardNavigator"
...
export const DemoShowroomScreen: FC<DashboardTabScreenProps<"DemoShowroom">> =
  function DemoShowroomScreen(_props) {
    const [open, setOpen] = useState(false)
    const timeout = useRef<ReturnType<typeof setTimeout>>()
    const listRef = useRef<SectionList>(null)
    const menuRef = useRef<ListViewRef<DemoListItem["item"]>>(null)
    const route = useRoute<RouteProp<DashboardTabParamList, "DemoShowroom">>()
