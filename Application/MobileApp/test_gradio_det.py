...
upload_url = f"https://kisenaa-bird-detection.hf.space/gradio_api/upload?upload_id={upload_id}"
...
post_url = "https://kisenaa-bird-detection.hf.space/gradio_api/call/yolo_inference"
post_resp = requests.post(post_url, json=payload)
post_resp.raise_for_status()
event_id = post_resp.json()["event_id"]

# 4. Poll for the result
get_url = f"https://kisenaa-bird-detection.hf.space/gradio_api/call/yolo_inference/{event_id}"
